...
<head>
    <meta charset="UTF-8">
    <title>Learn Things :: single post</title>
...
<body>
    ...
    <!-- section -->
    <div class="section blog_margins">
        <!-- container -->
        <div class="container">
            <!-- row -->
            <div class="row">
                    ...
                    <div class="section-row">
                        <div class="post-nav">
                            <div class="prev-post">
                                ...
                                <h3 class="post-title"><a href="#">Sed ut perspiciatis, unde omnis iste natus error
                                        sit</a></h3>
                            ...
                            <div class="next-post">
                                ...
                                <h3 class="post-title"><a href="#">Postea senserit id eos, vivendo periculis ei qui</a>
                                </h3>
                                <span>Next post</span>
                            </div>
                        </div>
        ...
        <script src="https://mdbootstrap.com/api/snippets/static/download/MDB-Pro_4.19.2/js/bootstrap.min.js">
        </script>
